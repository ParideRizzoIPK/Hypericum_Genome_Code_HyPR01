...
def generate_db_plots(base_dir):
    ...
    # Standardised publication-quality color scheme
    ...
    for db in db_keys:
        ...
        # Compile structures for Matplotlib
        ...
        ax.set_title(f'BUSCO Comparison - {db.upper()} Lineage', fontsize=13, fontweight='bold', pad=15)
        ax.set_xlim(0, 100)
